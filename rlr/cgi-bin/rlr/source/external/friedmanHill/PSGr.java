package external.friedmanHill; /*lcb*/
...
//for Java 1.1, uncomment the following two lines                     /*lcb*/
//  /** not implemented */                                            /*lcb*/
//  public java.awt.Shape getClip() {return null;}                    /*lcb*/
//  /** not implemented */                                            /*lcb*/
//  public void setClip(java.awt.Shape s) {}                          /*lcb*/

  /** not implemented */                                            /*lcb*/
  public java.awt.Rectangle getClipBounds() {return null;}          /*lcb*/
  /** not implemented */                                            /*lcb*/
  public void setClip(int x,int y,int width,int height) {}          /*lcb*/
  /** not implemented */                                            /*lcb*/
  public void drawPolyline(int[] x,int[] y,int z) {}                /*lcb*/
  /** not implemented */                                            /*lcb*/
  public boolean drawImage(java.awt.Image i,                        /*lcb*/
          int i1,int i2,int i3,int i4,int i5,int i6,int i7,int i8,  /*lcb*/
          java.awt.Color c,java.awt.image.ImageObserver o)          /*lcb*/
          {return false;}                                           /*lcb*/
  /** not implemented */                                            /*lcb*/
  public boolean drawImage(java.awt.Image i,                        /*lcb*/
          int i1,int i2,int i3,int i4,int i5,int i6,int i7,int i8,  /*lcb*/
          java.awt.image.ImageObserver o) {return false;}           /*lcb*/
  ...
  /**
   * Write out the end of the PostScript file.  This should be
   * called after everything has been drawn.
   */                                                            /*lcb*/
  public void close() {                                          /*lcb*/
    os.println("showpage");                                      /*lcb*/
    os.println("%%Pages: 1");                                    /*lcb*/
    os.println("%%EOF");                                         /*lcb*/
  }                                                              /*lcb*/
  ...
  public void setFont(Font f) {
    if (f != null) {
      ...
      if (javaName.equals("Symbol"))
        ...
        case (Font.ITALIC + Font.BOLD):
          psName += "-BoldOblique"; break;   /*lcb*/
        }
      }

      else
        psName = "Helvetica";  /*lcb*/ //default should be same as defined in Prolog, not Courier
  ...
  public void clipRect(int x, int y, int width, int height) {
    clippingRect = clippingRect.intersection(new Rectangle(x,y,width,height));  /*lcb*/
    y = transformY(y);
    os.println("newpath");   /*lcb*/
    os.println(""+ x       +" "+ y        +" moveto");  /*lcb*/
    os.println(""+(x+width)+" "+ y        +" lineto");  /*lcb*/
    os.println(""+(x+width)+" "+(y-height)+" lineto");  /*lcb*/
    os.println(""+ x       +" "+(y-height)+" lineto");  /*lcb*/
    os.println("closepath clip");                       /*lcb*/
  }
  ...
  private void doPoly(int xPoints[], int yPoints[], int nPoints, boolean fill) {
    ...
    os.println("newpath");   /*lcb*/
    os.print(xPoints[0]);   /*lcb*/
    os.print(" ");          /*lcb*/
    os.print(newYPoints[0]);/*lcb*/
    os.println(" moveto");

    for (i=0; i<nPoints; i++) {
      os.print(xPoints[i]);   /*lcb*/
      os.print(" ");          /*lcb*/
      os.print(newYPoints[i]);/*lcb*/
      os.println(" lineto");
    }
  ...
  protected void emitProlog() {
    ...
    os.println(""+XOFFSET+" "+(-YOFFSET)+" translate");  /*lcb*/
    setFont(font);
  }
