package pointer;
/**
  * This is a pointer to an array of doubles, used for pass-by-reference calls.
...
public class PDoubleArray1D extends Pointer {
  ...
  public boolean equalVal(Pointer obj) {
    if (!(obj instanceof PDoubleArray1D) ||
        obj==null)
      return false;
    double[] v=((PDoubleArray1D)obj).val;
    if (v==null && val==null)
      return true;
    if ((v==null && val!=null) ||
        (v!=null && val==null) ||
