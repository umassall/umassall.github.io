/****************************************************************/
/* Implementation of native code for class matrix.MatrixD,      */
/* filling in the body for each function                        */
/* defined as "extern" in "matrix_MatrixD.h", using the         */
/* same parameter names as in matrix.MatrixD.java.              */
...
//not written yet:
//     multColMat, multMatCol, multDiag, replaceVector

#include <StubPreamble.h>
#include "matrix_MatrixD.h"
#include <stdio.h>
#define DEBUG
...
//loop through all corresponding elements in two vectors, possibly one row and one column
#define FOR_SAME_ELEMENTS_VECTOR(_m1,_c1,_m2,_c2)     \
   {                                                  \
     long   next1     =_m1->obj->next;                \
     long   next2     =_m2->obj->next;                \
     _c1              =_m1->obj->data->obj->body +    \
                       _m1->obj->first;               \
     _c2              =_m2->obj->data->obj->body +    \
                       _m2->obj->first;               \
     double *last1    =_m1->obj->data->obj->body +    \
                       _m1->obj->last;                \
     for   (; _c1<=last1; _c1+=next1 ,_c2+=next22 )   \
#define NEXT_SAME_ELEMENTS_VECTOR }
...
#define FOR_MULT_OUTER(_m1,_c1,_m2,_c2,_m3,_c3)     \
   {                                                \
     ...
     double *_endR1, *_endC1, *_endR2, *_c3s;       \
     _c1              =_m1->obj->data->obj->body +  \
                       _m1->obj->first;             \
     _c2              =_m2->obj->data->obj->body +  \
                       _m2->obj->first;             \
...
int64_t matrix_MatrixD_native_version
          (struct Hmatrix_MatrixD *t) {
  return 1; //version 1 (don't change this unless the interface changes)
} //end version

long /*boolean*/ matrix_MatrixD_native_equalEls
          (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           struct Hmatrix_MatrixD *m) {
  double *thisCursor, *mCursor;
...
struct Hmatrix_MatrixD *matrix_MatrixD_native_add1
	  (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           struct Hmatrix_MatrixD *m) {
  double *thisCursor, *mCursor;
...
struct Hmatrix_MatrixD *matrix_MatrixD_native_sub
	  (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           struct Hmatrix_MatrixD *m) {
  double *thisCursor, *mCursor;
...
struct Hmatrix_MatrixD *matrix_MatrixD_native_subFrom
	  (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           struct Hmatrix_MatrixD *m) {
  double *thisCursor, *mCursor;
...
struct Hmatrix_MatrixD *matrix_MatrixD_native_multAdd
	  (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           double k,
           struct Hmatrix_MatrixD *m) {
  double *thisCursor, *mCursor;
...
struct Hmatrix_MatrixD *matrix_MatrixD_native_addMult
	  (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           double k,
           struct Hmatrix_MatrixD *m) {
  double *thisCursor, *mCursor;
...
double matrix_MatrixD_native_dot
	  (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           struct Hmatrix_MatrixD *v) {
  double dot=0;
  double *vCursor   =   v->obj->data->obj->body +
                        v->obj->first;
  double *thisCursor=this->obj->data->obj->body +
                     this->obj->first;
  double *last      =this->obj->last + thisCursor;
...
struct Hmatrix_MatrixD *matrix_MatrixD_native_replace
	  (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           struct Hmatrix_MatrixD *m) {
  double *thisCursor, *mCursor;
...
struct Hmatrix_MatrixD *matrix_MatrixD_native_replaceVector
	  (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           struct Hmatrix_MatrixD *m) {
  double *thisCursor, *mCursor;

  FOR_SAME_ELEMENTS_VECTOR(this,thisCursor,m,mCursor)
    *thisCursor = *mCursor;
  NEXT_SAME_ELEMENTS_VECTOR;

  return this;
}//end replaceVector


struct Hmatrix_MatrixD *matrix_MatrixD_native_add2
	  (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           double k) {
  double *cursor; //points to each element of the array
...
struct Hmatrix_MatrixD *matrix_MatrixD_native_diag1
   (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           double k) {
  double *cursor =this->obj->data->obj->body +  //start of data array
                  this->obj->first;             //offset of start of this matrix
  double *last   =this->obj->last + cursor;     //lower-right corner of matrix
  long nextRowCol=this->obj->nextRow +          //go down one row ...
                  this->obj->nextCol;           //   and right one column

  matrix_MatrixD_native_mult2 (0,this,0);
...
struct Hmatrix_MatrixD *matrix_MatrixD_native_diag2
	  (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           struct Hmatrix_MatrixD *v) {
  double *cursor =this->obj->data->obj->body +  //start of data array
                  this->obj->first;             //offset of start of this matrix
  double *last   =this->obj->data->obj->body +
...
struct Hmatrix_MatrixD *matrix_MatrixD_native_mult1
	  (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           struct Hmatrix_MatrixD *x,
           struct Hmatrix_MatrixD *y) {
  double *te,*xe,*ye; //pointer to current element of this, x, and y respectively
...
struct Hmatrix_MatrixD *matrix_MatrixD_native_mult2
	  (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           double k) {
  double *cursor; //points to each element of the array
...
struct Hmatrix_MatrixD *matrix_MatrixD_native_multK
	  (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           double k,
           struct Hmatrix_MatrixD *m) {
  matrix_MatrixD_native_replace(t,this,m);
  matrix_MatrixD_native_mult2  (t,this,k);
  return this;
}//end multK


struct Hmatrix_MatrixD *matrix_MatrixD_native_multEl
	  (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           struct Hmatrix_MatrixD *m) {
  double *thisCursor, *mCursor;
...
struct Hmatrix_MatrixD *matrix_MatrixD_native_multColMat
	  (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           struct Hmatrix_MatrixD *x,
           long   col,
           struct Hmatrix_MatrixD *v) {
...
struct Hmatrix_MatrixD *matrix_MatrixD_native_multMatCol
	  (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           struct Hmatrix_MatrixD *x,
           struct Hmatrix_MatrixD *y,
           long   col) {
...
struct Hmatrix_MatrixD *matrix_MatrixD_native_multDiag
	  (struct Hmatrix_MatrixD *t,struct Hmatrix_MatrixD *this,
           struct Hmatrix_MatrixD *x,
           struct Hmatrix_MatrixD *y) {
