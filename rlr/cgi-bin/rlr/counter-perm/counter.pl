...
$count_file = "/user/cgi/rlr/counter/count.txt";
$digit_dir = "/user/cgi/rlr/counter/digits/";
$access_log = "/user/web/logs/access_log";
$error_log = "/user/web/logs/error_log";

$flyprog = "/user/cgi/rlr/counter/fly/fly -q";
$fly_temp = "/user/cgi/rlr/counter/fly/fly_temp.txt";

$bad_referer_img = "http://www.cps.msu.edu/cgi-user/rlr/counter/bad_referer.gif";

@referers = ("www.cps.msu.edu","web.cps.msu.edu");
