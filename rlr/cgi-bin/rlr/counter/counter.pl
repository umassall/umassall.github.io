...
$count_file = "/anw/www-anw/httpd/htdocs/rlr/cgi-bin/rlr/counter/count.txt";
$digit_dir = "/anw/www-anw/httpd/htdocs/rlr/cgi-bin/rlr/counter/digits/";
$access_log = "/user/web/logs/access_log";
$error_log = "/user/web/logs/error_log";

$flyprog = "/anw/www-anw/httpd/htdocs/rlr/cgi-bin/rlr/counter/fly/fly -q";
$fly_temp = "/anw/www-anw/httpd/htdocs/rlr/cgi-bin/rlr/counter/fly/fly_temp.txt";

$bad_referer_img = "http://www-anw.cs.umass.edu/rlr/cgi-bin/rlr/counter/bad_referer.gif";
#@referers = ("www.cse.msu.edu","web.cse.msu.edu","web.cps.msu.edu","www.cps.msu.edu");
@referers = ("www-anw.cs.umass.edu","entropy.cs.umass.edu","www-all.cs.umass.edu");
