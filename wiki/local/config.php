...
$WikiTitle = 'WikiWikiALL';

##  $ScriptUrl is your preferred URL for accessing wiki pages
##  $PubDirUrl is the URL for the pub directory.
$ScriptUrl = 'http://www-anw.cs.umass.edu/wiki/pmwiki.php';
$PubDirUrl = 'http://www-anw.cs.umass.edu/wiki/pub';
...
$PageLogoUrl = "$PubDirUrl/ALL_logo_mini.gif";
...
$DefaultPasswords['admin'] = crypt('d@tr@ck7');
...
$EnableUpload = 1;                       
$DefaultPasswords['upload'] = crypt('bellman');
...
$DefaultPasswords['read'] = crypt('bellman');
$DefaultPasswords['edit'] = crypt('bellman');
$Skin = 'monobook';
